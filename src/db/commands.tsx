import ContactInfoTerminalContent from "../components/Fragments/ContanctInfoTerminalContent";
import EducationTerminalContent from "../components/Fragments/EducationTerminalContent";
import ExperienceAboutMeTerminalContent from "../components/Fragments/ExperienceAboutMeTerminalContent";
import ExperienceTerminalContent from "../components/Fragments/ExperienceTerminalContent";
import GeneralAboutMeTerminalContent from "../components/Fragments/GeneralAboutMeTerminalContent";
import ProjectsTerminalContent from "../components/Fragments/ProjectsTerminalContent";
...
const commands = [
  ...
  },
  {
    ...
    examples: [
      ...
      },
      {
        ...
        description: "displays information about the user in more detail",
      },
    ],
    commandValues: [
      {
  ...
  },
  {
    ...
    content: (
      <div>
        ...
        <ul>
          <li>
            <strong>list</strong> - Lists various categories (e.g., skills,
            projects, etc.)
          </li>
          <li>
            <strong>whoami</strong> - Displays information about the user
          </li>
          <li>
          ...
          <li>
            <strong>npm-info</strong> - Displays information about npm package of this terminal. 
          </li>
        </ul>
      </div>
    ),
  ...
  },
  {
    ...
    content: (
      <div>
        <p>Want to implement this feature? <i className="underline underline-offset-4">npm install terminal-lite</i>.</p>
        <p>More information can be found in the documentation.</p>
        <a
          href="https://www.npmjs.com/package/terminal-lite"
          className="text-blue-300 underline underline-offset-4"
          target="_blank"
        >
          https://www.npmjs.com/package/terminal-lite
        </a>
      </div>
    ),
    examples: [
