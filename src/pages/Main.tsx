...
const Main = () => {
  ...
  ╚══╝╚══╝ ╚══════╝╚══════╝ ╚═════╝ ╚═════╝ ╚═╝     ╚═╝╚══════╝
        ...
        <div className="flex flex-col items-center justify-between bg-background-dark border text-sm border-primary-border-dark text-primary font-tech-mono flex-1 p-4">
          <span className="font-bold h-fit text-2xl text-gray-300 under py-1 px-2 ">
      ...
      <div className="flex gap-4">
        <Terminal title="MDY.png" className="!w-[300px] h-[400px]">
          <img src={profile} alt="" className="object-cover" />
        </Terminal>
        <Terminal
          title="About.txt"
          className="h-[400px] flex-1 text-2xl leading-8"
        >
